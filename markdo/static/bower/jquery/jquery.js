...
// Pass this if window is not defined yet
    ...
    ((window => {
        ...
        function matcherFromGroupMatchers( elementMatchers, setMatchers ) {
            ...
            var superMatcher = (seed, context, xml, results, outermost) => {
                var elem, j, matcher,
                    matchedCount = 0,
                    i = "0",
                    unmatched = seed && [],
						...
						jQuery.each( tuples, (i, tuple) => {
							...
							deferred[ tuple[1] ](function(...args) {
								...
								if ( returned && jQuery.isFunction( returned.promise ) ) {
									...
									newDefer[ tuple[ 0 ] + "With" ]( this === promise ? newDefer.promise() : this, fn ? [ returned ] : args );
								}
							});
						});
						fns = null;
    ...
    */
    ...
    jQuery.fn.extend({
        ...
        replaceWith(...args) {
            ...
            this.domManip( args, function( elem ) {
                arg = this.parentNode;
    ...
    function actualDisplay( name, doc ) {
        ...
        var // getDefaultComputedStyle might be reliably used only on attached element
    ...
    var getStyles = elem => elem.ownerDocument.defaultView.getComputedStyle( elem, null );
    ...
    function addGetHookIf( conditionFn, hookFn ) {
        ...
        return {
            get(...args) {
                ...
                return (this.get = hookFn).apply( this, args );
            }
        };
    }
    ...
    var rfxnum = new RegExp( "^(?:([+-])=|)(" + pnum + ")([a-z%]*)$", "i" );
    var rrun = /queueHooks$/;
        ...
        toggleClass(value, stateVal) {
            ...
            return this.each(function() {
                if ( type === "string" ) {
                    ...
                    var classNames = value.match( rnotwhite ) || [];
